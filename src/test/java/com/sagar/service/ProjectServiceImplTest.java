...
class ProjectServiceImplTest {
    ...
    void createProject_persistsAndReturnsSuccess() {
        ...
        String result = service.createProject(dto).await().indefinitely();
    ...
    void getAllProjects_returnsMappedList() {
        ...
        List<ProjectDTO> result = service.getAllProjects().await().indefinitely();
    ...
    void updateProject_withValidId_updatesAndReturnsDTO() {
        ...
        ProjectDTO result = service.updateProject(validId, dto).await().indefinitely();
    ...
    void updateProject_withInvalidId_throwsBadRequest() {
        assertThatThrownBy(() -> service.updateProject(TestDataFactory.INVALID_ID, dto).await().indefinitely())
    ...
    void updateProject_withUnknownId_throwsNotFound() {
        ...
        assertThatThrownBy(() -> service.updateProject(validId, dto).await().indefinitely())
                .isInstanceOf(ApplicationException.class)
    ...
    void deleteProject_withValidId_deletesAndReturnsSuccess() {
        ...
        String result = service.deleteProject(validId).await().indefinitely();
    ...
    void deleteProject_withUnknownId_throwsNotFound() {
        ...
        assertThatThrownBy(() -> service.deleteProject(validId).await().indefinitely())
                .isInstanceOf(ApplicationException.class)
                .extracting("statusCode").isEqualTo(AppConstants.STATUS_NOT_FOUND);
    }
}
